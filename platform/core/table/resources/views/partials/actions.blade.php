<div class="table-actions">
    ...
    @if (!empty($item->id!=NULL))
        @if (Auth::user()->hasPermission($edit))
            <a href="{{ route('tables.duplicate', ['id' => $item->id]) }}" class="btn btn-icon btn-sm btn-primary duplicate" data-toggle="tooltip" data-original-title="Duplicate"><i class="fa fa-copy"></i></a>
        @endif
    @endif
