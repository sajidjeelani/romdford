...
$(document).ready(function() {
            $.ajax({
                url: '{{ route("orders.get_courier") }}', // Replace with your actual API endpoint URL
                method: 'GET',
                dataType: 'json',// Use GET or POST based on your API
        ...
        function buildDropdown(data){
          var courierName = "@php
           ...
           @endphp";
            var dropdown = document.getElementById("courierDropdown");
            for (var i = 0; i < data.length; i++) {
            var option = document.createElement("option");
            option.text = data[i]["courier_name"];
            option.value = data[i]["id"];
            if (data[i]["courier_name"] === courierName) {
                                                ...
                                                @endphp
                                                    ...
                                                    <td class="pl5 p-r5 min-width-200-px">
                                                        ...
                                                        @if($order->gift_wrap>0)
                                                            <div><b>This Item Need To be Gift Wrapped</b></div>
                                                        @endif 
                            ...
                            <div class="pd-all-20 p-none-t">
                                <div class="flexbox-grid-default block-rps-768">
                                    ...
                                    <div class="flexbox-auto-right pl5">
                                        <div class="table-wrap">
                                            <table class="table-normal table-none-border table-color-gray-text">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right color-subtext mt10">
                                                        <p class="mb0">{{ trans('Gift Wrap') }}</p>
                                                    </td>
                                                    <td class="text-right p-none-t pl10">
                                                        <p class="mb0">{{ format_price($order->gift_wrap) }}</p>
                                                    </td>
                                                </tr>
                                        ...
                                        <div class="pd-all-20">
                                            <form action="{{ route('orders.courier_details',$order->id)}}">
                                                <label class="text-title-field">Courier Name</label>
                                                <select class="ui-text-area textarea-auto-height" id="courierDropdown" name="courierName">
                                                    <!-- Options will be added here -->
                                                </select>
                                                <label class="text-title-field">Tracking Number</label>
                                                <textarea class="ui-text-area textarea-auto-height" name="trackingnum" rows="3" >{{$order->tracking_number}}</textarea>
