    ...
    <div class="address-form-wrapper" @if (auth('customer')->check() && $isAvailableAddress && (!empty($sessionAddressId) && $sessionAddressId !== 'new' || empty(Arr::get($sessionCheckoutData, 'state')))) style="display: none;" @endif>
        <div class="row">
            ...
            <div class="col-lg-4 col-12">
                <div class="form-group">
                    <input type="text" name="address[company_name]" id="address_company_name" placeholder="{{ __('Company Name') }}" class="form-control address-control-item checkout-input" value="{{ old('address.company_name', Arr::get($sessionCheckoutData, 'company_name')) }}">
                </div>
            </div>
        </div>
        ...
        <div class="row">
                        ...
                        <div class="select--arrow">
                            <select name="address[country]" class="form-control address-control-item" id="address_country">
                                @foreach(['' => __('Select country...')] + EcommerceHelper::getAvailableCountries() as $countryCode => $countryName)
                                    <option value="{{ $countryCode }}" @if (old('address.country', Arr::get($sessionCheckoutData, 'country')) == $countryCode) selected @elseif ( "GB" == $countryCode)  selected @endif>{{ $countryName }}</option>
                                @endforeach
                            </select>
            ...
            <div class="col-sm-6 col-12">
                <div class="form-group @if ($errors->has('address.state')) has-error @endif">
                    <input id="address_state" type="text" class="form-control address-control-item checkout-input" placeholder="{{ __('County / State') }}" name="address[state]" value="{{ old('address.state', Arr::get($sessionCheckoutData, 'state')) }}">
            ...
            <div class="col-sm-6 col-12">
                <div class="form-group  @if ($errors->has('address.city')) has-error @endif">
                    <input id="address_city" type="text" class="form-control address-control-item checkout-input" placeholder="{{ __('Town / City') }}" name="address[city]" value="{{ old('address.city', Arr::get($sessionCheckoutData, 'city')) }}">
            ...
            <div class="col-12">
                <div class="form-group @if ($errors->has('address.address')) has-error @endif">
                    <input id="address_address" type="text" class="form-control address-control-item checkout-input" placeholder="{{ __('Address 1') }}" name="address[address]" value="{{ old('address.address', Arr::get($sessionCheckoutData, 'address')) }}">
                    {!! Form::error('address.address', $errors) !!}
                </div>
            </div>
            <div class="col-12">
                <div class="form-group">
                    <input id="address_address1" type="text" class="form-control address-control-item checkout-input" placeholder="{{ __('Address 2') }}" name="address[address1]" value="{{ old('address.address1', Arr::get($sessionCheckoutData, 'address1')) }}">
                </div>
            </div>
            <div class="col-12">
                <div class="form-group">
                    <input id="address_aaddress" type="text" class="form-control address-control-item checkout-input" placeholder="{{ __('Additional Address') }}" name="address[aaddress]" value="{{ old('address.aaddress', Arr::get($sessionCheckoutData, 'aaddress')) }}">
                </div>
            </div>
            ...
            @if (EcommerceHelper::isZipCodeEnabled())
                <div class="col-12">
                    <div class="form-group @if ($errors->has('address.zip_code')) has-error @endif">
                        <input id="address_zip_code" type="text" class="form-control address-control-item checkout-input" placeholder="{{ __('Post code / Zip Code') }}" name="address[zip_code]" value="{{ old('address.zip_code', Arr::get($sessionCheckoutData, 'zip_code')) }}">
