                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="product-quantity" data-title="{{ __('Qty') }}">
                                                                <div class="product-quantity row">
                                                                    <span data-value="+" class="col-md-3 quantity-btn quantityPlus"></span>
                                                                    <input class="col-md-6 quantity input-lg" step="1" min="1" max="9" title="{{ __('Qty') }}" value="{{ $cartItem->qty }}" name="items[{{ $key }}][values][qty]" type="number" />
                                                                    <span data-value="-" class="col-md-3 quantity-btn quantityMinus"></span>
                                                                </div>
                                                            </td>
