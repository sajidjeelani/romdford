...
class RegisterController extends Controller
{
    ...
    */
    ...
    public function register(Request $request, BaseHttpResponse $response)
    {
        ...
        $coupon=$this->setNewCustomerWelCoupon($customer->id,$customer->name);
    ...
    public function setNewCustomerWelCoupon(int $id,string $name){
        
        $coupon = $this->randomString(6);
        ...
        $couponInsertID = DB::table('ec_discount_customers')->insertGetId([
            'discount_id'=>$CopuPonid,
            'customer_id'=>$id,
        ]);  
        
        
        $user = DB::table('ec_customers')->where('id', $id)->first();
